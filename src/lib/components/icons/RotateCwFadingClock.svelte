<script lang="ts">
	// lucide `rotate-cw-fading-clock` — not yet in the pinned lucide-svelte 0.562.0,
	// vendored from the official SVG so we don't need a major (0.x → 1.0) bump.
	// Drop-in with the same `class`/rest-props surface as a lucide-svelte icon.
